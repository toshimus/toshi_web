...
function runValidation(isAfterCorrection = false) {
    ...
    if (hasEmpty) {
        ...
        if (allCorrect) {
            ...
            if (window.judgeSettings.correct.soundData) window.playSound(window.judgeSettings.correct.soundData);
            isSolved = true;
            ...
            if (window.judgeSettings.incorrect.soundData) window.playSound(window.judgeSettings.incorrect.soundData);
            window.mistakeCount++; 
        }
    }
}
